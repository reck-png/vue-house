...
var vue_router_esm_bundler_exports = {};
__export(vue_router_esm_bundler_exports, {
...
var hasSymbol, PolySymbol, matchedRouteKey, viewDepthKey, routerKey, routeLocationKey, routerViewLocationKey, isBrowser, assign, noop, TRAILING_SLASH_RE, removeTrailingSlash, NavigationType, NavigationDirection, START, BEFORE_HASH_RE, computeScrollPosition, scrollPositions, createBaseLocation, START_LOCATION_NORMALIZED, NavigationFailureSymbol, NavigationFailureType, ErrorTypeMessages, propertiesToLog, BASE_PARAM_PATTERN, BASE_PATH_PARSER_OPTIONS, REGEX_CHARS_RE, ROOT_TOKEN, VALID_PARAM_RE, HASH_RE, AMPERSAND_RE, SLASH_RE, EQUAL_RE, IM_RE, PLUS_RE, ENC_BRACKET_OPEN_RE, ENC_BRACKET_CLOSE_RE, ENC_CARET_RE, ENC_BACKTICK_RE, ENC_CURLY_OPEN_RE, ENC_PIPE_RE, ENC_CURLY_CLOSE_RE, ENC_SPACE_RE, RouterLinkImpl, RouterLink, getLinkClass, RouterViewImpl, RouterView, routerId, PINK_500, BLUE_600, LIME_500, CYAN_400, ORANGE_400, DARK, routeRecordId, EXTRACT_REGEXP_RE;
var init_vue_router_esm_bundler = __esm({
  "node_modules/vue-router/dist/vue-router.esm-bundler.js"() {
    init_vue_runtime_esm_bundler();
    init_esm();
    hasSymbol = typeof Symbol === "function" && typeof Symbol.toStringTag === "symbol";
    PolySymbol = (name) => hasSymbol ? Symbol(true ? "[vue-router]: " + name : name) : (true ? "[vue-router]: " : "_vr_") + name;
    matchedRouteKey = PolySymbol(true ? "router view location matched" : "rvlm");
    viewDepthKey = PolySymbol(true ? "router view depth" : "rvd");
    routerKey = PolySymbol(true ? "router" : "r");
    routeLocationKey = PolySymbol(true ? "route location" : "rl");
    routerViewLocationKey = PolySymbol(true ? "router view location" : "rvl");
    ...
    NavigationFailureSymbol = PolySymbol(true ? "navigation failure" : "nf");
 ...
 ${JSON.stringify(location2)}${currentLocation ? "\nwhile being at\n" + JSON.stringify(currentLocation) : ""}`;
    ...
    propertiesToLog = ["params", "query", "hash"];
    BASE_PARAM_PATTERN = "[^/]+?";
    ...
    ENC_SPACE_RE = /%20/g;
    RouterLinkImpl = defineComponent({
      name: "RouterLink",
      compatConfig: { MODE: 3 },
      props: {
        to: {
...
export {
  ...
  useRouter,
  useRoute,
  vue_router_esm_bundler_exports,
  init_vue_router_esm_bundler
};
/*!
  * vue-router v4.0.16
  ...
  * @license MIT
  */
//# sourceMappingURL=chunk-QOMIMHGB.js.map
